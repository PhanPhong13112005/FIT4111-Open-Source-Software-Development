...
<head>
    ...
    <link href="/baitaplon/css/login.css" rel="stylesheet">
    ...
    <div class="login-container">
        <div class="login-box">
            <div class="text-center mb-3">
                <img src="/baitaplon/images/logo.png" alt="Logo" class="logo">
                <h5 class="text-success fw-bold mt-2">OCE - Online Course Education</h5>
                <h2 class="text-muted mb-3">Đăng nhập hệ thống</h2>
            </div>
            <form action="/baitaplon/handle/login_process.php" method="POST">
                ...
                <div class="text-center mt-3">
                    <small>Chưa có tài khoản? <a href="register.php"
