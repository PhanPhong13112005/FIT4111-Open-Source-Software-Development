        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="/BaiTapLon/views/student/my_courses.php">Danh Sách khóa học đã đăng kí</a>
                    <li class="nav-item">
                        <a class="nav-link" href="subject.php"></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="grade.php"></a>
                    </li>
                    <li class="nav-item">
